...
// by corking the graph stream. we should fix the multiplex stream
// per channel backpressure instead since this is more or less a hack
var HWM = 1000000 // arbitrary high number
...
module.exports = function (self, opts) {
  ...
  var queue = parallel(16, {highWaterMark: HWM}, function (node, cb) {
  ...
  var graph = self._index.log.replicate(xtend(opts, {finalize: finalize, process: queue}))
